...
import at.braendle.campus.classes.FourisWiningClass;

import java.util.ArrayList;

public class FourIsWinning {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            FourisWiningClass.playstone();

            System.out.println(FourisWiningClass.playstone());
